...
public class MovieController {
	...
	public String viewMovieById(@PathVariable Optional<String> id, Model model) {
		if(!id.isPresent()) {
			model.addAttribute("id", "movie not found");
			return "error";
		} else {
	...
	@RequestMapping("/movie/update/{id}/duration/{dur}")
	public String updateMovieById(@PathVariable String id, @PathVariable Integer dur, Model model) {
		String newUpdate = movieService.updateMovie(id, dur);
	...
	public String deleteById(@PathVariable String id, Model model) {
		String delete = movieService.deleteMovie(id);
